...
RUN cd /home/admin && \
    ...
    #安装 hadoop
    cd /home/admin && \
	wget -c -nv --no-check-certificate https://archive.apache.org/dist/hadoop/core/hadoop-2.7.0/hadoop-2.7.0.tar.gz && \
    ...
    # 安装 hbase 
    cd /home/admin && \
	wget -c -nv --no-check-certificate  https://archive.apache.org/dist/hbase/1.1.2/hbase-1.1.2-bin.tar.gz && \
	tar -zxf hbase-1.1.2-bin.tar.gz && \
    ...
    #安装 hive 
    cd /home/admin && \
	wget -c -nv --no-check-certificate  https://archive.apache.org/dist/hive/hive-1.2.1/apache-hive-1.2.1-bin.tar.gz && \
    ...
    #安装 spark 
    cd /home/admin && \
    wget -c -nv --no-check-certificate   https://archive.apache.org/dist/spark/spark-2.3.1/spark-2.3.1-bin-hadoop2.6.tgz && \
	tar -zxf spark-2.3.1-bin-hadoop2.6.tgz && \
    ...
    # 安装 kafka
    cd /home/admin && \
	wget -c -nv --no-check-certificate  https://archive.apache.org/dist/kafka/1.1.1/kafka_2.11-1.1.1.tgz && \
    ...
    #安装 kylin 
    cd /home/admin && \
	wget -c -nv --no-check-certificate https://archive.apache.org/dist/kylin/apache-kylin-3.1.1/apache-kylin-3.1.1-bin-hbase1x.tar.gz && \
	tar -zxf apache-kylin-3.1.1-bin-hbase1x.tar.gz && \
    rm -rf  apache-kylin-3.1.1-bin-hbase1x.tar.gz && \
	mv apache-kylin-3.1.1-bin-hbase1x kylin && \
